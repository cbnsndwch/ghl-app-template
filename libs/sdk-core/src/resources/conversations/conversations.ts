...
import * as Models from './models/conversations.js';
...
export class Conversations {
    ...
    async searchConversation(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'followers', in: 'query' },
            { name: 'mentions', in: 'query' },
            { name: 'query', in: 'query' },
            { name: 'sort', in: 'query' },
            { name: 'startAfterDate', in: 'query' },
            { name: 'id', in: 'query' },
            { name: 'limit', in: 'query' },
            { name: 'lastMessageType', in: 'query' },
            { name: 'lastMessageAction', in: 'query' },
            { name: 'lastMessageDirection', in: 'query' },
            { name: 'status', in: 'query' },
            { name: 'sortBy', in: 'query' },
            { name: 'sortScoreProfile', in: 'query' },
            { name: 'scoreProfile', in: 'query' },
            { name: 'scoreProfileMin', in: 'query' },
            { name: 'scoreProfileMax', in: 'query' }
        ];
        ...
        const response: AxiosResponse<Models.SendConversationResponseDto> =
    ...
    async getConversation(
        ...
        const response: AxiosResponse<Models.GetConversationByIdResponse> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateConversation(
        ...
        const response: AxiosResponse<Models.GetConversationSuccessfulResponse> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteConversation(
        ...
        const response: AxiosResponse<Models.DeleteConversationSuccessfulResponse> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getEmailById(
        ...
        const response: AxiosResponse<Models.GetEmailMessageResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async cancelScheduledEmailMessage(
        ...
        const response: AxiosResponse<Models.CancelScheduledResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getMessage(
        ...
        const response: AxiosResponse<Models.GetMessageResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getMessages(
        ...
        const response: AxiosResponse<Models.GetMessagesByConversationResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async sendANewMessage(
        ...
        const response: AxiosResponse<Models.SendMessageResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async addAnInboundMessage(
        ...
        const response: AxiosResponse<Models.ProcessMessageResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async uploadFileAttachments(
        ...
        const response: AxiosResponse<Models.UploadFilesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getMessageTranscription(
        ...
        const response: AxiosResponse<Models.GetMessageTranscriptionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async liveChatAgentTyping(
        ...
        const response: AxiosResponse<Models.CreateLiveChatMessageFeedbackResponse> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createConversation(
        ...
        const response: AxiosResponse<Models.CreateConversationSuccessResponse> =
            await this.client.request(config);
        return response.data;
    }
}
