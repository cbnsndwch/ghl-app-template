...
import * as Models from './models/store.js';
...
export class Store {
    ...
    async createShippingZone(
        ...
        const response: AxiosResponse<Models.CreateShippingZoneResponseDto> =
    ...
    async listShippingZones(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'withShippingRate', in: 'query' }
        ];
        ...
        const response: AxiosResponse<Models.ListShippingZoneResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getShippingZones(
        ...
        const response: AxiosResponse<Models.GetShippingZoneResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateShippingZone(
        ...
        const response: AxiosResponse<Models.UpdateShippingZoneResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteShippingZone(
        ...
        const response: AxiosResponse<Models.DeleteShippingZoneResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getAvailableShippingZones(
        ...
        const response: AxiosResponse<Models.GetAvailableShippingRatesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createShippingRate(
        ...
        const response: AxiosResponse<Models.CreateShippingRateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listShippingRates(
        ...
        const response: AxiosResponse<Models.ListShippingRateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getShippingRates(
        ...
        const response: AxiosResponse<Models.GetShippingRateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateShippingRate(
        ...
        const response: AxiosResponse<Models.UpdateShippingRateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteShippingRate(
        ...
        const response: AxiosResponse<Models.DeleteShippingRateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createShippingCarrier(
        ...
        const response: AxiosResponse<Models.CreateShippingCarrierResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listShippingCarriers(
        ...
        const response: AxiosResponse<Models.ListShippingCarrierResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getShippingCarriers(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'shippingCarrierId', in: 'path' },
            { name: 'altId', in: 'query' },
            { name: 'altType', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        ...
        const response: AxiosResponse<Models.GetShippingCarrierResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateShippingCarrier(
        ...
        const response: AxiosResponse<Models.UpdateShippingCarrierResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteShippingCarrier(
        ...
        const response: AxiosResponse<Models.DeleteShippingCarrierResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createStoreSetting(
        ...
        const response: AxiosResponse<Models.CreateStoreSettingResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getStoreSettings(
        ...
        const response: AxiosResponse<Models.GetStoreSettingResponseDto> =
            await this.client.request(config);
        return response.data;
    }
}
