...
import * as Models from './models/funnels.js';
...
export class Funnels {
    ...
    async createRedirect(
        ...
        const response: AxiosResponse<Models.CreateRedirectResponseDTO> =
    ...
    async updateRedirectById(
        ...
        const response: AxiosResponse<Models.UpdateRedirectResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteRedirectById(
        ...
        const response: AxiosResponse<Models.DeleteRedirectResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async fetchRedirectsList(
        ...
        const response: AxiosResponse<Models.RedirectListResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getFunnels(
        ...
        const response: AxiosResponse<Models.FunnelListResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getPagesByFunnelId(
        ...
        const response: AxiosResponse<Models.FunnelPageResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getPagesCountByFunnelId(
        ...
        const response: AxiosResponse<Models.FunnelPageCountResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
}
