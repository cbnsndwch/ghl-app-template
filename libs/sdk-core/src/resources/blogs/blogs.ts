...
import * as Models from './models/blogs.js';
...
export class Blogs {
    ...
    async checkUrlSlugExists(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'urlSlug', in: 'query' },
            { name: 'locationId', in: 'query' },
            { name: 'postId', in: 'query' }
        ];
        ...
        const response: AxiosResponse<Models.UrlSlugCheckResponseDTO> =
    ...
    async updateBlogPost(
        ...
        const response: AxiosResponse<Models.BlogPostUpdateResponseWrapperDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createBlogPost(
        ...
        const response: AxiosResponse<Models.BlogPostCreateResponseWrapperDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getAllBlogAuthorsByLocation(
        ...
        const response: AxiosResponse<Models.AuthorsResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getAllCategoriesByLocation(
        ...
        const response: AxiosResponse<Models.CategoriesResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getBlogPost(
        ...
        const response: AxiosResponse<Models.BlogPostGetResponseWrapperDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getBlogs(
        ...
        const response: AxiosResponse<Models.BlogGetResponseWrapperDTO> =
            await this.client.request(config);
        return response.data;
    }
}
