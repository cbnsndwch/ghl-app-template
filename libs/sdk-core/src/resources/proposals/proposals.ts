...
import * as Models from './models/proposals.js';
...
export class Proposals {
    ...
    async listDocumentsContracts(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'paymentStatus', in: 'query' },
            { name: 'limit', in: 'query' },
            { name: 'skip', in: 'query' },
            { name: 'query', in: 'query' },
            { name: 'dateFrom', in: 'query' },
            { name: 'dateTo', in: 'query' }
        ];
        ...
        const response: AxiosResponse<Models.DocumentListResponseDto> =
    ...
    async sendDocumentsContracts(
        ...
        const response: AxiosResponse<Models.SendDocumentResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listDocumentsContractsTemplates(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'type', in: 'query' },
            { name: 'name', in: 'query' },
            { name: 'isPublicDocument', in: 'query' },
        ...
        const response: AxiosResponse<Models.TemplateListPaginationResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async sendDocumentsContractsTemplate(
        ...
        const response: AxiosResponse<Models.SendTemplateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
}
