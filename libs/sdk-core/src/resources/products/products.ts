...
export class Products {
    ...
    async bulkUpdate(
        ...
        const response: AxiosResponse<Models.BulkUpdateResponseDto> =
    ...
    async bulkEdit(
        ...
        const response: AxiosResponse<Models.BulkEditResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createPriceForProduct(
        ...
        const response: AxiosResponse<Models.CreatePriceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listPricesForProduct(
        ...
        const response: AxiosResponse<Models.ListPricesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getListInventory(
        ...
        const response: AxiosResponse<Models.GetInventoryResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateInventory(
        ...
        const response: AxiosResponse<Models.UpdateInventoryResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getPriceByIdForProduct(
        ...
        const response: AxiosResponse<Models.GetPriceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updatePriceByIdForProduct(
        ...
        const response: AxiosResponse<Models.UpdatePriceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deletePriceByIdForProduct(
        ...
        const response: AxiosResponse<Models.DeletePriceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getProductStoreStats(
        ...
        const response: AxiosResponse<Models.GetProductStatsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateStoreStatus(
        ...
        const response: AxiosResponse<Models.UpdateProductStoreResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getProductCollection(
        ...
        const response: AxiosResponse<Models.ListCollectionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createProductCollection(
        ...
        const response: AxiosResponse<Models.CreateCollectionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getProductCollectionId(
        ...
        const response: AxiosResponse<Models.DefaultCollectionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateProductCollection(
        ...
        const response: AxiosResponse<Models.UpdateProductCollectionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteProductCollection(
        ...
        const response: AxiosResponse<Models.DeleteProductCollectionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getProductReviews(
        ...
        const response: AxiosResponse<Models.ListProductReviewsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getReviewsCount(
        ...
        const response: AxiosResponse<Models.CountReviewsByStatusResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateProductReview(
        ...
        const response: AxiosResponse<Models.UpdateProductReviewsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteProductReview(
        ...
        const response: AxiosResponse<Models.DeleteProductReviewResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getProductById(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'productId', in: 'path' },
            { name: 'locationId', in: 'query' },
            { name: 'sendWishlistStatus', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        const requirements: string[] = ['Location-Access', 'Agency-Access'];
        ...
        const response: AxiosResponse<Models.GetProductResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteProductById(
        ...
        const response: AxiosResponse<Models.DeleteProductResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateProductById(
        ...
        const response: AxiosResponse<Models.UpdateProductResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createProduct(
        ...
        const response: AxiosResponse<Models.CreateProductResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listInvoices(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'search', in: 'query' },
            { name: 'collectionIds', in: 'query' },
            { name: 'collectionSlug', in: 'query' },
            { name: 'expand', in: 'query' },
            { name: 'productIds', in: 'query' },
            { name: 'storeId', in: 'query' },
            { name: 'includedInStore', in: 'query' },
            { name: 'availableInStore', in: 'query' },
            { name: 'sortOrder', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        const requirements: string[] = ['Location-Access', 'Agency-Access'];
        ...
        const response: AxiosResponse<Models.ListProductsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
}
