...
import * as Models from './models/locations.js';
...
export class Locations {
    ...
    async searchLocations(
        ...
        const response: AxiosResponse<Models.SearchSuccessfulResponseDto> =
    ...
    async getLocation(
        ...
        const response: AxiosResponse<Models.GetLocationByIdSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async putLocation(
        ...
        const response: AxiosResponse<Models.CreateLocationSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteLocation(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'locationId', in: 'path' },
            { name: 'deleteTwilioAccount', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        const requirements: string[] = ['Agency-Access'];
        ...
        const response: AxiosResponse<Models.LocationDeletedSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getLocationTags(
        ...
        const response: AxiosResponse<Models.LocationTagsSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createTag(
        ...
        const response: AxiosResponse<Models.LocationTagSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteTag(
        ...
        const response: AxiosResponse<Models.LocationTagDeleteSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async taskSearch(
        ...
        const response: AxiosResponse<Models.LocationTaskListSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getRecurringTaskById(
        ...
        const response: AxiosResponse<Models.RecurringTaskSingleResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteRecurringTask(
        ...
        const response: AxiosResponse<Models.DeleteRecurringTaskResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getCustomFields(
        ...
        const response: AxiosResponse<Models.CustomFieldsListSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createCustomField(
        ...
        const response: AxiosResponse<Models.CustomFieldSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteCustomField(
        ...
        const response: AxiosResponse<Models.CustomFieldDeleteSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async uploadFileCustomFields(
        ...
        const response: AxiosResponse<Models.FileUploadResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getCustomValues(
        ...
        const response: AxiosResponse<Models.CustomValuesListSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createCustomValue(
        ...
        const response: AxiosResponse<Models.CustomValueIdSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteCustomValue(
        ...
        const response: AxiosResponse<Models.CustomValueDeleteSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
     ...
     */
    async getTimezones(options?: AxiosRequestConfig): Promise<any> {
        const paramDefs: Array<{ name: string; in: string }> = [];
    ...
    async gETAllOrEmailSmsTemplates(
        ...
        const response: AxiosResponse<Models.GetTemplatesSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
