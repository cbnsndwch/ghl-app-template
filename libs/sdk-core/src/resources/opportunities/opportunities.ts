...
import * as Models from './models/opportunities.js';
...
export class Opportunities {
    ...
    async searchOpportunity(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'pipeline_id', in: 'query' },
            { name: 'pipeline_stage_id', in: 'query' },
            { name: 'contact_id', in: 'query' },
            { name: 'status', in: 'query' },
            { name: 'assigned_to', in: 'query' },
            { name: 'campaignId', in: 'query' },
            { name: 'id', in: 'query' },
            { name: 'order', in: 'query' },
            ...
            { name: 'page', in: 'query' },
            { name: 'limit', in: 'query' },
            { name: 'getTasks', in: 'query' },
            { name: 'getNotes', in: 'query' },
            { name: 'getCalendarEvents', in: 'query' }
        ];
    ...
    async getPipelines(
        ...
        const response: AxiosResponse<Models.GetPipelinesSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getOpportunity(
        ...
        const response: AxiosResponse<Models.GetPostOpportunitySuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteOpportunity(
        ...
        const response: AxiosResponse<Models.DeleteUpdateOpportunitySuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async upsertOpportunity(
        ...
        const response: AxiosResponse<Models.UpsertOpportunitySuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
