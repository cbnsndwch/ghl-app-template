...
export class Associations {
    ...
    async deleteAssociation(
        ...
        const response: AxiosResponse<Models.DeleteAssociationsResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
