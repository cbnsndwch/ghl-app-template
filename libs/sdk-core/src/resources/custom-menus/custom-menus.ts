...
import * as Models from './models/custom-menus.js';
...
export class CustomMenus {
    ...
    async getCustomMenuById(
        ...
        const response: AxiosResponse<Models.GetSingleCustomMenusSuccessfulResponseDTO> =
    ...
    async deleteCustomMenu(
        ...
        const response: AxiosResponse<Models.DeleteCustomMenuSuccessfulResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateCustomMenu(
        ...
        const response: AxiosResponse<Models.UpdateCustomMenuLinkResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getCustomMenus(
        ...
        const response: AxiosResponse<Models.GetCustomMenusResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
