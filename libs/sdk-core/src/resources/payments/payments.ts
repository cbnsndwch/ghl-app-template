...
import * as Models from './models/payments.js';
...
export class Payments {
    ...
    async createIntegrationProvider(
        ...
        const response: AxiosResponse<Models.CreateWhitelabelIntegrationResponseDto> =
    ...
    async listIntegrationProviders(
        ...
        const response: AxiosResponse<Models.ListWhitelabelIntegrationProviderResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listOrders(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'funnelProductIds', in: 'query' },
            { name: 'limit', in: 'query' },
            { name: 'offset', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        ...
        const response: AxiosResponse<Models.ListOrdersResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getOrderById(
        ...
        const response: AxiosResponse<Models.GetOrderResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async recordOrderPayment(
        ...
        const response: AxiosResponse<Models.PostRecordOrderPaymentResponse> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createOrderFulfillment(
        ...
        const response: AxiosResponse<Models.CreateFulfillmentResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listOrderFulfillment(
        ...
        const response: AxiosResponse<Models.ListFulfillmentResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listTransactions(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'startAt', in: 'query' },
            { name: 'endAt', in: 'query' },
            { name: 'entitySourceType', in: 'query' },
            { name: 'entitySourceSubType', in: 'query' },
            { name: 'search', in: 'query' },
        ...
        const response: AxiosResponse<Models.ListTxnsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getTransactionById(
        ...
        const response: AxiosResponse<Models.GetTxnResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listSubscriptions(
        ...
        const response: AxiosResponse<Models.ListSubscriptionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getSubscriptionById(
        ...
        const response: AxiosResponse<Models.GetSubscriptionResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listCoupons(
        ...
        const response: AxiosResponse<Models.ListCouponsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createCoupon(
        ...
        const response: AxiosResponse<Models.CreateCouponResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteCoupon(
        ...
        const response: AxiosResponse<Models.DeleteCouponResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createIntegration(
        ...
        const response: AxiosResponse<Models.CreateCustomProvidersResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteIntegration(
        ...
        const response: AxiosResponse<Models.DeleteCustomProvidersResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async fetchConfig(
        ...
        const response: AxiosResponse<Models.GetCustomProvidersResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createConfig(
        ...
        const response: AxiosResponse<Models.ConnectCustomProvidersResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async disconnectConfig(
        ...
        const response: AxiosResponse<Models.DisconnectCustomProvidersResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async customProviderMarketplaceAppUpdateCapabilities(
        ...
        const response: AxiosResponse<Models.UpdateCustomProviderCapabilitiesResponseSchema> =
            await this.client.request(config);
        return response.data;
    }
}
