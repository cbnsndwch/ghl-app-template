...
import * as Models from './models/surveys.js';
...
export class Surveys {
    ...
    async getSurveysSubmissions(
        ...
        const response: AxiosResponse<Models.GetSurveysSubmissionSuccessfulResponseDto> =
    ...
    async getSurveys(
        ...
        const response: AxiosResponse<Models.GetSurveysSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
}
