...
export class Users {
    ...
    async searchUsers(
        ...
        const response: AxiosResponse<Models.SearchUserSuccessfulResponseDto> =
    ...
    async getUser(
        ...
        const response: AxiosResponse<Models.UserSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteUser(
        ...
        const response: AxiosResponse<Models.DeleteUserSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getUserByLocation(
        ...
        const response: AxiosResponse<Models.LocationSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
