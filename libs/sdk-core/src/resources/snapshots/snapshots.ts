...
import * as Models from './models/snapshots.js';
...
export class Snapshots {
    ...
    async getCustomSnapshots(
        ...
        const response: AxiosResponse<Models.GetSnapshotsSuccessfulResponseDto> =
    ...
    async createSnapshotShareLink(
        ...
        const response: AxiosResponse<Models.CreateSnapshotShareLinkSuccessfulResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getSnapshotPush(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'snapshotId', in: 'path' },
            { name: 'companyId', in: 'query' },
            { name: 'from', in: 'query' },
            { name: 'to', in: 'query' },
            { name: 'lastDoc', in: 'query' },
            { name: 'limit', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        const requirements: string[] = ['Agency-Access'];
        ...
        const response: AxiosResponse<Models.GetSnapshotPushStatusSuccessfulResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getLatestSnapshotPush(
        ...
        const response: AxiosResponse<Models.GetLatestSnapshotPushStatusSuccessfulResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
}
