...
import * as Models from './models/custom-fields.js';
...
export class CustomFields {
   ...
   */
    async deleteCustomField(
        ...
        const response: AxiosResponse<Models.CustomFolderDeleteResponseDto> =
            await this.client.request(config);
        return response.data;
    }
   ...
   */
    async getCustomFieldsByObjectKey(
        ...
        const response: AxiosResponse<Models.CustomFieldsResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
   ...
   */
    async createCustomFieldFolder(
        ...
        const response: AxiosResponse<Models.ICustomFieldFolder> =
            await this.client.request(config);
        return response.data;
    }
