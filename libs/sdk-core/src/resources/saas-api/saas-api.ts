...
import * as Models from './models/saas-api.js';
...
export class SaasApi {
    ...
    async bulkDisableSaasDeprecated(
        ...
        const response: AxiosResponse<Models.BulkDisableSaasResponseDto> =
            await this.client.request(config);
        return response.data;
    }
   ...
   */
    async enableSaasLocationDeprecated(
        ...
        const response: AxiosResponse<Models.EnableSaasResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateRebillingDeprecated(
        ...
        const response: AxiosResponse<Models.UpdateRebillingResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getAgencyPlansDeprecated(
        ...
        const response: AxiosResponse<Models.AgencyPlanResponseDto[]> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getLocationSubscriptionDeprecated(
        ...
        const response: AxiosResponse<Models.LocationSubscriptionResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async bulkEnableSaasDeprecated(
        ...
        const response: AxiosResponse<Models.BulkEnableSaasResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getSaasLocationsDeprecated(
        ...
        const response: AxiosResponse<Models.GetSaasLocationsResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getSaasPlanDeprecated(
        ...
        const response: AxiosResponse<Models.SaasPlanResponseDto> =
            await this.client.request(config);
        return response.data;
    }
