...
import * as Models from './models/medias.js';
...
export class Medias {
    ...
    async fetchMediaContent(
        ...
        const response: AxiosResponse<Models.GetFilesResponseDTO> =
    ...
    async createMediaFolder(
        ...
        const response: AxiosResponse<Models.FolderDTO> =
            await this.client.request(config);
        return response.data;
    }
