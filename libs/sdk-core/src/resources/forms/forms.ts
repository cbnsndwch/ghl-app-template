...
import * as Models from './models/forms.js';
...
export class Forms {
    ...
    async getFormsSubmissions(
        ...
        const response: AxiosResponse<Models.FormsSubmissionsSuccessfulResponseDto> =
    ...
    async getForms(
        ...
        const response: AxiosResponse<Models.FormsSuccessfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
}
