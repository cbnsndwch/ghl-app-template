...
import * as Models from './models/voice-ai.js';
...
export class VoiceAi {
    ...
    async createAgent(
        ...
        const response: AxiosResponse<Models.CreateAgentResponseDTO> =
    ...
    async getAgents(
        ...
        const response: AxiosResponse<Models.GetAgentsResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async patchAgent(
        ...
        const response: AxiosResponse<Models.PatchAgentResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getAgent(
        ...
        const response: AxiosResponse<Models.GetAgentResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getCallLogs(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'locationId', in: 'query' },
            { name: 'agentId', in: 'query' },
            { name: 'contactId', in: 'query' },
            { name: 'callType', in: 'query' },
            { name: 'startDate', in: 'query' },
            { name: 'endDate', in: 'query' },
            { name: 'actionType', in: 'query' },
        ...
        const response: AxiosResponse<Models.CallLogsResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getCallLog(
        ...
        const response: AxiosResponse<Models.CallLogDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createAction(
        ...
        const response: AxiosResponse<Models.CreateActionResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateAction(
        ...
        const response: AxiosResponse<Models.UpdateActionResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getAction(
        ...
        const response: AxiosResponse<Models.GetActionResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
