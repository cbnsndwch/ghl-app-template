...
import * as Models from './models/emails.js';
...
export class Emails {
    ...
    async fetchCampaigns(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'emailStatus', in: 'query' },
            { name: 'name', in: 'query' },
            { name: 'parentId', in: 'query' },
            { name: 'limitedFields', in: 'query' },
            { name: 'archived', in: 'query' },
            { name: 'campaignsOnly', in: 'query' },
            { name: 'showStats', in: 'query' }
        ];
        ...
        const response: AxiosResponse<Models.ScheduleFetchSuccessfulDTO> =
    ...
    async createTemplate(
        ...
        const response: AxiosResponse<Models.CreateBuilderSuccesfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async fetchTemplate(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'sortByDate', in: 'query' },
            { name: 'archived', in: 'query' },
            { name: 'builderVersion', in: 'query' },
            { name: 'name', in: 'query' },
            { name: 'parentId', in: 'query' },
            { name: 'originId', in: 'query' },
            { name: 'templatesOnly', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        const requirements: string[] = ['Location-Access'];
        ...
        const response: AxiosResponse<Models.FetchBuilderSuccesfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteTemplate(
        ...
        const response: AxiosResponse<Models.DeleteBuilderSuccesfulResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateTemplate(
        ...
        const response: AxiosResponse<Models.BuilderUpdateSuccessfulDTO> =
            await this.client.request(config);
        return response.data;
    }
}
