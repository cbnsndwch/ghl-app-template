...
import * as Models from './models/invoices.js';
...
export class Invoices {
    ...
    async createInvoiceTemplate(
        ...
        const response: AxiosResponse<Models.CreateInvoiceTemplateResponseDto> =
    ...
    async listInvoiceTemplates(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            { name: 'altId', in: 'query' },
            { name: 'altType', in: 'query' },
            { name: 'status', in: 'query' },
            { name: 'startAt', in: 'query' },
            { name: 'endAt', in: 'query' },
            { name: 'search', in: 'query' },
            { name: 'paymentMode', in: 'query' },
            { name: 'limit', in: 'query' },
        ...
        const response: AxiosResponse<Models.ListTemplatesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getInvoiceTemplate(
        ...
        const response: AxiosResponse<Models.GetTemplateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateInvoiceTemplate(
        ...
        const response: AxiosResponse<Models.UpdateInvoiceTemplateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteInvoiceTemplate(
        ...
        const response: AxiosResponse<Models.DeleteInvoiceTemplateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.CreateInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listInvoiceSchedules(
        ...
        const response: AxiosResponse<Models.ListSchedulesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.GetScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.UpdateInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.DeleteInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateAndScheduleInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.UpdateAndScheduleInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async scheduleInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.ScheduleInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async autoPaymentInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.AutoPaymentInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async cancelInvoiceSchedule(
        ...
        const response: AxiosResponse<Models.CancelInvoiceScheduleResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async text2payInvoice(
        ...
        const response: AxiosResponse<Models.Text2PayInvoiceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async generateInvoiceNumber(
        ...
        const response: AxiosResponse<Models.GenerateInvoiceNumberResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getInvoice(
        ...
        const response: AxiosResponse<Models.GetInvoiceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async updateInvoice(
        ...
        const response: AxiosResponse<Models.UpdateInvoiceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteInvoice(
        ...
        const response: AxiosResponse<Models.DeleteInvoiceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async voidInvoice(
        ...
        const response: AxiosResponse<Models.VoidInvoiceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async sendInvoice(
        ...
        const response: AxiosResponse<Models.SendInvoicesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async recordInvoice(
        ...
        const response: AxiosResponse<Models.RecordPaymentResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createNewEstimate(
        ...
        const response: AxiosResponse<Models.EstimateResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async generateEstimateNumber(
        ...
        const response: AxiosResponse<Models.GenerateEstimateNumberResponse> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createInvoiceFromEstimate(
        ...
        const response: AxiosResponse<Models.CreateInvoiceFromEstimateResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listEstimates(
        ...
        const response: AxiosResponse<Models.ListEstimatesResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listEstimateTemplates(
        ...
        const response: AxiosResponse<Models.ListEstimateTemplateResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createEstimateTemplate(
        ...
        const response: AxiosResponse<Models.EstimateTemplateResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async createInvoice(
        ...
        const response: AxiosResponse<Models.CreateInvoiceResponseDto> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async listInvoices(
        ...
        const paramDefs: Array<{ name: string; in: string }> = [
            ...
            { name: 'limit', in: 'query' },
            { name: 'offset', in: 'query' },
            { name: 'sortField', in: 'query' },
            { name: 'sortOrder', in: 'query' }
        ];
        const extracted = extractParams(params, paramDefs);
        const requirements: string[] = ['Location-Access', 'Agency-Access'];
        ...
        const response: AxiosResponse<Models.ListInvoicesResponseDto> =
            await this.client.request(config);
        return response.data;
    }
}
