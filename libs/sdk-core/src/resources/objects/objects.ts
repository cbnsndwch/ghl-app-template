...
import * as Models from './models/objects.js';
...
export class Objects {
    ...
    async getObjectSchemaByKey(
        ...
        const response: AxiosResponse<Models.CustomObjectByIdResponseDTO> =
    ...
    async updateCustomObject(
        ...
        const response: AxiosResponse<Models.CustomObjectResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getRecordById(
        ...
        const response: AxiosResponse<Models.RecordByIdResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async deleteObjectRecord(
        ...
        const response: AxiosResponse<Models.ObjectRecordDeleteResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async searchObjectRecords(
        ...
        const response: AxiosResponse<Models.SearchRecordResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
    ...
    async getObjectByLocationId(
        ...
        const response: AxiosResponse<Models.CustomObjectListResponseDTO> =
            await this.client.request(config);
        return response.data;
    }
